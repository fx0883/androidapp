...
/**
 * Created by mihwapp on 11/20/17.
 */
...
//
    ...
    wifiOninterface interfaceEnable;

    public interface wifiOninterface {
        void wifiEnabled();
    }
...
//        isHalloween = NoInternetUtils.getCurrentDate().equals("10-31");
    ...
    public void seDialogListeners(wifiOninterface oninterface) {
        interfaceEnable = oninterface;
...
//        Log.e("oncreatw===","true");
    ...
    public void onWifiTurnedOn() {
        if (wifiAnimator != null && wifiAnimator.isStarted()) {
            ...
            if (interfaceEnable!=null)
            {
                interfaceEnable.wifiEnabled();
            }
        }
    }
